...
void SaveCFG(const char* FileName)
{
    ...
    char Path[0x100];
    sprintf(Path, "C:\\Windows\\Temp\\SteepCheat\\");

    if (!folder_exists(Path))
        _mkdir(Path);
    cfg.SetUnicode();
    char result[0x100];
    sprintf(result, "C:\\Windows\\Temp\\SteepCheat\\%s.ini", FileName);
...
#pragma region PlayerMisk
    ...
    cfg.SetLongValue("Misc", "Speed Hack Value", Vars::Misc::SpeedValue);
...
#pragma region Aim Color
    ...
    SaveColorValue("Aim - Color", "Silent Fov Color", Vars::Color::SilentFovColor);
...
#pragma region PlayerMisk
    ...
    Vars::Misc::SpeedValue = cfg.GetBoolValue("Misc", "Speed Hack Value", Vars::Misc::SpeedValue);
...
#pragma region Aim Color
       ...
       LoadColorValue("Aim - Color", "Silent Fov Color", Vars::Color::SilentFovColor);
